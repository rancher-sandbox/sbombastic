...
func (c *FakeImages) Apply(ctx context.Context, image *storagev1alpha1.ImageApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Image, err error) {
	if image == nil {
...
func (c *FakeImages) ApplyStatus(ctx context.Context, image *storagev1alpha1.ImageApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Image, err error) {
	if image == nil {
		return nil, fmt.Errorf("image provided to Apply must not be nil")
	}
	data, err := json.Marshal(image)
