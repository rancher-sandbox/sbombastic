...
// SBOMsGetter has a method to return a SBOMInterface.
// A group's client should implement this interface.
type SBOMsGetter interface {
	SBOMs(namespace string) SBOMInterface
}

// SBOMInterface has methods to work with SBOM resources.
type SBOMInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*storagev1alpha1.SBOMList, error)
...
// sBOMs implements SBOMInterface
type sBOMs struct {
	*gentype.ClientWithListAndApply[*storagev1alpha1.SBOM, *storagev1alpha1.SBOMList, *applyconfigurationstoragev1alpha1.SBOMApplyConfiguration]
}

// newSBOMs returns a SBOMs
func newSBOMs(c *StorageV1alpha1Client, namespace string) *sBOMs {
	return &sBOMs{
		gentype.NewClientWithListAndApply[*storagev1alpha1.SBOM, *storagev1alpha1.SBOMList, *applyconfigurationstoragev1alpha1.SBOMApplyConfiguration](
			"sboms",
			c.RESTClient(),
