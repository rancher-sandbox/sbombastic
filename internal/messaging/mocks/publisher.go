...
func (_mock *MockPublisher) Publish(ctx context.Context, subject string, message []byte) error {
...
//   - subject string
//   - message []byte
func (_e *MockPublisher_Expecter) Publish(ctx interface{}, subject interface{}, message interface{}) *MockPublisher_Publish_Call {
	return &MockPublisher_Publish_Call{Call: _e.mock.On("Publish", ctx, subject, message)}
}

func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, subject string, message []byte)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(ctx context.Context, subject string, message []byte) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
